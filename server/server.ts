...
// // app.get('/asset-details.html', (req: Request, res: Response) => {
// //     res.sendFile(path.join(__dirname, 'asset-details.html'));
// // });

// // app.get('/portfolio.html', (req: Request, res: Response) => {
...
// // List of cryptocurrencies
// const symbols: string[] = [
//     "btcusdt", "bnbusdt", "ethusdt", "bchusdt", "xrpusdt",
//     "eosusdt", "ltcusdt", "trxusdt", "etcusdt", "linkusdt"
// ];
